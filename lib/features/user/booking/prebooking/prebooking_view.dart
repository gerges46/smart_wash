      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            /// 🔹 Card
            BookingCard(lastBooking: lastBooking),
            ...
            SizedBox(
              ...
              child: ElevatedButton(
                ...
                onPressed: () {
                  Navigator.pushNamed(context, Routes.myBookingsRoute);
                },
                child: Text(
            ...
            Center(
              child: Text(
                AppStrings.thankYou,
                style: TextStyle(color: AppColors.darkGrey, fontSize: 15.sp),
              ),
            ),
          ],
        ),
